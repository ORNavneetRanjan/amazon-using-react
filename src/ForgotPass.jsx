...
function ForgotPass(){
    ...
    const {handleChange, handleBlur, values, touched, handleSubmit, errors} = useFormik({
        initialValues : {
            email: "",
        },
        ...
        <div className="grow bg-gray-200 flex p-10">
            <div className="bg-sky-500 grow max-w-screen-lg m-auto h-svh flex flex-col gap-10 justify-center items-center">
                ...
                className="gap-2 flex flex-col justify-center items-center">
                    ...
                    {touched.email && errors.email && <div className="text-2xl text-red-300">{errors.email}</div>}
                    <span className="flex flex-col gap-1">
                        ...
                        >
                        Send OTP</button>
                        <Link to="/signin" className="text-white text-left self-end">SignIn</Link>
                    </span>
                </form>
            </div>
        </div>
